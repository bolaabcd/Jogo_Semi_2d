...
public Textura(String fileNome) {
	...
	try {
		...
		if(GlobalVariables.debugue==true)System.out.println("COMPRIMENTO DA TEXTURA:");
		width=bi.getWidth();
		if(GlobalVariables.debugue==true)System.out.println(width);
		height=bi.getHeight();
		...
		if(GlobalVariables.debugue==true)System.out.println();
		if(GlobalVariables.debugue==true)System.out.println("INICIANDO CONTAGEM DOS PIXELS:");
		for(int c=0;c<width;c++) {
			for(int a=0;a<height;a++) {
				//RED,GREEN,BLUE,ALPHA!
				if(GlobalVariables.debugue==true)System.out.println("COR DO PIXEL EM x="+a+", y="+c);
				if(GlobalVariables.debugue==true)System.out.println("RED="+((prgba[c*height+a]&0x00FF0000)>>16));
				if(GlobalVariables.debugue==true)System.out.println("GREEN="+((prgba[c*height+a]&0x0000FF00)>>8));
				if(GlobalVariables.debugue==true)System.out.println("BLUE="+((prgba[c*height+a]&0x000000FF)));
				if(GlobalVariables.debugue==true)System.out.println("ALPHA="+((prgba[c*height+a]&0xFF000000)>>>24));
		...
		if(GlobalVariables.debugue==true)System.out.println("FINALIZADA CONTAGEM DOS PIXELS!");
		if(GlobalVariables.debugue==true)System.out.println();
		if(GlobalVariables.debugue==true)System.out.println();
/*
